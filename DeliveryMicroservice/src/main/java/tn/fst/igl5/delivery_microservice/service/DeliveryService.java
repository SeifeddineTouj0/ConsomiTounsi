...
public class DeliveryService {
    ...
    private Delivery mapToEntity(final DeliveryDTO deliveryDTO, final Delivery delivery) {
        ...
        final DeliveryPerson deliveryPerson = deliveryDTO.getDeliveryPerson() == null ? null : deliveryPersonRepository.findById(deliveryDTO.getDeliveryPerson())
                .orElseThrow(() -> new NotFoundException("deliveryPerson not found"));
